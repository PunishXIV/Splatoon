...
### Spore sac mechanics (phase 1 and 2)
```
...
```
~Lv2~{"Name":"M7S Stoneringer phase 2/3","Group":"AAC Cruiserweight M3 Savage","ZoneLockH":[1261],"ElementsL":[{"Name":"Out","type":1,"radius":25.0,"refActorNPCNameID":13756,"refActorRequireCast":true,"refActorCastId":[42386,42403],"refActorComparisonType":6,"refActorTetherTimeMin":0.0,"refActorTetherTimeMax":0.0},{"Name":"Line","type":3,"refY":80.0,"radius":7.0,"refActorNPCNameID":13756,"refActorRequireCast":true,"refActorCastId":[43340,43358],"refActorComparisonType":6,"includeRotation":true,"refActorTetherTimeMin":0.0,"refActorTetherTimeMax":0.0},{"Name":"In","type":1,"radius":22.0,"Donut":50.0,"fillIntensity":0.5,"refActorNPCNameID":13756,"refActorRequireCast":true,"refActorCastId":[42387,42405],"refActorComparisonType":6,"refActorTetherTimeMin":0.0,"refActorTetherTimeMax":0.0}]}
```
...
### Lashing lariat (might be incomplete)
```
