...
internal static class Logger
{
    ...
    internal static void BeginLogging()
    {
        Safe(delegate
        {
            ...
            var fileName = $"{DateTimeOffset.Now:yyyy-MM-ddzzz HH.mm.ss} - {Svc.Data.GetExcelSheet<TerritoryType>().GetRow(Svc.ClientState.TerritoryType).ContentFinderCondition.Value.Name}.txt".Replace(":", "_");
