...
internal class P2_Missing_1238_4567_Pair : SplatoonScript
{
    #region Metadata
    ...
    [
        new(0, 2, 1, 1,
        [
            Rule("211_LeftTowerStack", PositionBasis.LeftTower, 315f, DefaultRangeInside),
            Rule("211_LeftTowerCone", PositionBasis.LeftTower, 45f, DefaultRangeInside),
            Rule("211_LeftTowerStackOutside", PositionBasis.LeftTower, 315f, DefaultRangeOutside),
            Rule("211_LeftTowerBaitCone", PositionBasis.LeftTower, 45f, DefaultRangeOutside),
        ...
        new(1, 0, 2, 2,
        [
            Rule("022_LeftTowerConeLeft", PositionBasis.LeftTower, 45f, DefaultRangeInside),
    ...
    private static bool TryApplyFirstHalfSpreadPair(PlayerInfo stackPlayer, PlayerInfo spreadPlayer)
    {
    ...
    private static bool TryApplyFirstHalfConePair(PlayerInfo stackPlayer, PlayerInfo conePlayer)
    {
