...
public unsafe class Aloalo_Bombs : SplatoonScript
{
    ...
    private const uint BombNameID = 0x30E8;
    ...
    public override void OnUpdate()
    {
        if(Unsafe != 0)
        {
            ...
            if(unsafeArray != null)
            {
                for(var i = 0; i < unsafeArray.Length; i++)
                {
    ...
    private List<List<IBattleNpc>> GetBombSets()
    {
    ...
    private List<IBattleNpc> GetBombSetFor(IBattleNpc? bnpc)
    {
